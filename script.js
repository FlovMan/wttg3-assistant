...
const MINERS = {
  tier1: {
    ...
    computers: [
      ...
      { name: "UserJyx", rate: 2.02, access: [384, 768], fail: [120, 480], reset: [120, 300] },
      { name: "NetVorn", rate: 1.62, access: [380, 1008], fail: [240, 420], reset: [240, 300] },
      { name: "CloudFuz", rate: 0.99, access: [440, 928], fail: [180, 240], reset: [180, 220] },
      { name: "SysBlip", rate: 0.97, access: [384, 768], fail: [40, 80], reset: [120, 240] },
      { name: "DevQuix", rate: 0.72, access: [408, 744], fail: [110, 220], reset: [60, 90] },
      { name: "IT_Kwez", rate: 0.47, access: [445.6, 884.8], fail: [20, 45], reset: [120, 190] },
      { name: "DataRax", rate: 0.34, access: [368, 752], fail: [45, 70], reset: [30, 210] },
      { name: "WorkZap", rate: 0.33, access: [384, 768], fail: [90, 210], reset: [180, 220] },
      { name: "CodePlix", rate: 0.33, access: [384, 768], fail: [15, 25], reset: [30, 75] },
    ],
  },
  tier2: {
    label: "Tier II",
...
const I18N = {
  pl: {
    ...
    minerCostTier2: "50 DOS",
    minerCostTier3: "125 DOS",
    minerAccess: "Access",
    minerFailCd: "Fail CD",
